...
import { promiseRaceComponent } from './src/concepts/04-promiserace'
import { asyncComponent } from './src/concepts/05-async'
import { asyncAwaitComponent } from './src/concepts/06-async-await'
import { asyncAwaitComponentSecuencial } from './src/concepts/07-async-await-secuencial'
import { forAwaitComponent } from './src/concepts/08-for-await'
import { generatorFunction } from './src/concepts/09-generator-function'
...
// asyncAwaitComponentSecuencial(element);
// forAwaitComponent(element);
// generatorFunction(element);
